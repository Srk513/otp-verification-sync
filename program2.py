...
class otp_verifier(Tk):
    def __init__(self):
        ...
        self.n = str(self.OTP())
        self.client = Client("AC860de711d41d0b3210e8680d20d1edd6", "7b34e439972287b11027a38507205462")
        self.client.messages.create(to =("+918329476003"),
                      from_ ="+17069672246",
                     body = self.n)
...
### Center textboxes
        ...
        self.simpli_logo = PhotoImage(file = "Simplilearn Logo.png")
        self.d = Label(self, image= self.simpli_logo, fg="#FFFFFF").place(x=870, y= 530 )
